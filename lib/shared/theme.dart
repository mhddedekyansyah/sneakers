...
const Color defaultBackground = Color(0xFF1F1D2B);
const Color background = Color(0xFF242231);
const Color background1 = Color(0xFFECEDEF);
const Color backgroundColor2 = Color(0xff2B2844);
...
const Color onlineColor = Color(0xFF51C17E);
